# Historical experiment notes — 2026-09-17–18

Archived from the benchmark guide. Conclusions describe each experiment at the time;
see the [current guide](../README.md) for the production configuration.
...
[Raw measurements and build metadata](llvm-pgo-20260917.json).
...
[Final revalidation](diverse-pgo-20260917-cancel-fix.json) follows the
...
[Earlier diverse-profile measurements](diverse-pgo-20260917.json) are
...
[Threshold-only follow-up](gc-settings-20260917.json): same validation
...
[Raw samples and metadata](o3-comparison-20260917.json). Same master
...
[Second experiment](o3-repeat-20260917.json): six blocks in ABC, BCA,
...
[Two-round local Full LTO/CSPGO results and investigation](compiler-20260918/README.md):
...
[Subsequent CSPGO repair and actual Linux BOLT experiment](compiler-followup-20260918/README.md)
...
[macOS GUI comparison](macos-pgo-20260918.json): ten warm-cache samples
